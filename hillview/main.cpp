...
void fristDesign(){
       ...
       // glVertex2f(-0.28,0.9);
        ...
        glColor3ub(179, 0, 0);
        renderBitmapString(-.15,.26,(void *)font1,"River Side Hill Scenario");
        ...
        glColor3ub(255, 0, 0);
        renderBitmapString(-0.189,-0.048,(void *)font2,"Noor Zuhan-18-36515-1");
        renderBitmapString(-0.189,-0.12,(void *)font2,"Fariha,monira Akter-18-36555-1");
        renderBitmapString(-0.189,-0.20,(void *)font2,"Khan ,Md. Nasim- 18-36530-1");
        renderBitmapString(-0.189,-0.28,(void *)font2,"Tahmid, M. M.A.-18-37341-1");
...
void sound()
{
    PlaySound(TEXT("thunderrain"), NULL, SND_FILENAME | SND_ASYNC);
